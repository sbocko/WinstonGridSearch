...
/**
 * This class stores single result of decision tree (J48) algorithm run for given dataset {datasetName}
...
public class DecisionTreeSearchResult extends SearchResult {
    ...
    public DecisionTreeSearchResult(String datasetName, double rmse, double confidenceFactor, int minimumNumberOfInstancesPerLeaf, boolean unpruned) {
